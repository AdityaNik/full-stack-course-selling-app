...
function UpdateCard() {
    ...
    const [title, setTitle] = useState<string>(courseDetails.course.title === undefined ? "" : courseDetails.course.title);
    const [description, setDescription] = useState<string>(courseDetails.course.description === undefined ? "" : courseDetails.course.description);
    const [price, setPrice] = useState<number>(courseDetails.course.price === undefined ? 0 : courseDetails.course.price);
    const [imageLink, setImage] = useState<string>(courseDetails.course.imageLink === undefined ? "" : courseDetails.course.imageLink);

    useEffect(() => {
        setTitle(courseDetails.course.title === undefined ? "" : courseDetails.course.title);
        setDescription(courseDetails.course.description === undefined ? "" : courseDetails.course.description);
        setPrice(courseDetails.course.price === undefined ? 0 : courseDetails.course.price);
        setImage(courseDetails.course.imageLink === undefined ? "" : courseDetails.course.imageLink);
    }, [courseDetails])
